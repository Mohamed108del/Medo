(function() {
        ...
        if (b)
            a: {
                ...
                b != null && (a ? k(q, d, {
                    ...
                    writable: !0,
                    value: b
                }) : b !== c && (t[d] === void 0 && (a = Math.random() * 1E9 >>> 0,
                t[d] = p ? m.Symbol(d) : "$jscp$" + a + "$" + d),
                k(g, t[d], {
                    configurable: !0,
                    writable: !0,
                    value: b
    ...
    function na(a) {
        this.next = function(b) {
            D(a.g);
            a.g.i ? b = H(a, a.g.i.next, b, a.g.v) : (a.g.v(b),
            b = I(a));
            return b
        }
        ;
        this.throw = function(b) {
            D(a.g);
            a.g.i ? b = H(a, a.g.i["throw"], b, a.g.v) : (E(a.g, b),
            b = I(a));
            return b
        }
        ;
    ...
    w("Promise", function(a) {
        ...
        b.prototype.W = function() {
            ...
            typeof e === "function" ? e = new e("unhandledrejection",{
                ...
                cancelable: !0
            }) : (e = m.document.createEvent("CustomEvent"),
...
*/
    var qa = q.globalThis.trustedTypes, K;
    function ra() {
        var a = null;
        if (!qa)
            return a;
...
*/
    ...
    ;var X = {}
      , Ta = (X["internal-error"] = -1,
    X["non-recoverable-error"] = -2,
    X["api-disabled-by-application"] = -3,
    X["invalid-argument"] = -4,
    X["token-provider-invalid"] = -5,
    X);
    function Ua() {
        this.u = !1
    }
    ...
    function Wa(a) {
        ...
        return J(function(c) {
            if (c.g == 1)
                return c.m = 2,
                F(c, window.android.webview.getExperimentalMediaIntegrityTokenProvider({
    ...
    function cb(a) {
        return J(function(b) {
            ...
            a.l = b.h;
            a.l ? b = F(b, Sa(a.config, a.l), 0) : (b.g = 0,
            b = void 0);
            return b
        })
    }
    function eb(a) {
        ...
        return J(function(f) {
            ...
            case 3:
                return d = Date.now() - b,
                c.N ? F(f, Sa(a.config, void 0, c.N, d), 0) : c.M ? F(f, W(16, a.config, "ftpe=" + String(Y().g) + ",ptb=" + String(c.M), d), 0) : F(f, W(18, a.config, "ftpe=" + String(Y().g), d), 0)
            }
        })
    }
    function fb(a, b) {
        function c(g) {
            g && g.data !== null && g.origin === "https://www.google.com" && g.source != null && g.source === b.contentWindow && (a.h = "id=sodar2&v=237",
            a.config && (a.h += "&li=" + encodeURIComponent(a.config.I.toString()),
            a.h += "&" + (a.config.context === "cr" ? "bgai" : "jk") + "=" + encodeURIComponent(a.config.F.toString()),
            g.source.postMessage(JSON.stringify({
                id: "sodar",
                params: a.h
            }), "https://www.google.com"),
            d.removeEventListener("message", c, !1)),
            f.resolve())
        }
        var d = window
          , f = new $a;
    ...
    function db(a) {
        ...
        return J(function(f) {
            if (f.g == 1)
                return b = M((a.j ? "https://ep2.adtrafficquality.google/sodar/" : "https://tpc.googlesyndication.com/sodar/") + "sodar2/237/runner.html"),
                F(f, xa(b), 2);
            if (f.g != 4) {
                c = f.h;
                if (!c.contentWindow)
                ...
                a.i = g;
                return a.i.g ? (g = a.config,
                e = g.j ? "https://ep2.adtrafficquality.google" : "https://tpc.googlesyndication.com",
                e = e.indexOf("https:") === -1 ? "http:" + e : e,
                a.i.h.postMessage(JSON.stringify([g.context, g.C, g.B, g.I, g.F, g.K, g.H === void 0 ? "n" : g.H, g.o === void 0 ? "0" : g.o, g.G === void 0 ? "1" : g.G, g.j === void 0 ? "0" : g.j ? "1" : "0"]), e),
                f.return(void 0)) : F(f, Ma(a.i, {
                    X: a.config.C,
                    J: a.config.B,
                    o: a.o,
                    j: a.config.j
